...
internal sealed class ReserveBookingCommandHandler(IUserRepository userRepository,
                                                   ...
                                                   : ICommandHandler<ReserveBookingCommand, Guid>
{
    public async Task<Result<Guid>> Handle(ReserveBookingCommand request, CancellationToken cancellationToken)
    {
        ...
        Booking booking = Booking.Reserve(apartment, user.Id, duration, dateTimeProvider.UtcNow);
