...
public static class DependencyInjection
{
    ...
    {
        string connectionString = configuration.GetConnectionString(name: "Database") ?? throw new ArgumentNullException(nameof(configuration));
    ...
    private static void AddAuthentication(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<AuthenticationOptions>(configuration.GetSection(key: "Authentication"));

        services.ConfigureOptions<JwtBearerOptionsSetup>();

        services.Configure<KeycloakOptions>(configuration.GetSection(key: "Keycloak"));
