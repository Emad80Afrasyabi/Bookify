...
public class FunctionalTestWebAppFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    private readonly KeycloakContainer _keycloakContainer = new KeycloakBuilder()
        .WithResourceMapping(
            source: new FileInfo(fileName: ".files/bookify-realm-export.json"),
            target: new FileInfo(fileName: "/opt/keycloak/data/import/realm.json"))
    ...
    private async Task InitializeTestUserAsync()
    {
        ...
        await httpClient.PostAsJsonAsync(requestUri: "api/v1/users/register", UserData.RegisterTestUserRequest);
    }
}
