...
public class RegisterUserTests(FunctionalTestWebAppFactory factory) : BaseFunctionalTest(factory)
{
    ...
    public async Task Register_ShouldReturnBadRequest_WhenRequestIsInvalid(string email, string firstName, string lastName,
        string password)
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await HttpClient.PostAsJsonAsync(requestUri: "api/v1/users/register", request);
    ...
    {
        // Arrange
        var request = new RegisterUserRequest(Email: "create@test.com", FirstName: "first", LastName: "last", Password: "12345");
